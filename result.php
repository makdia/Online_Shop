						...
						if(isset($_GET['search'])) {
							...
							if($count_pro==0) {
								...
								if($count__type_pro==0) {
									...
									echo "<h2 style='font-family:verdana, arial, helvetica, helve, sans-serif;padding-top:70px;padding-bottom:70px;margin-left:350px;float:center;'>No products available in this type!!!</h2>";
								}
								else { ?>
								<div class="section group">
								 <?php while($row_pro=mysqli_fetch_array($run_type)) {
