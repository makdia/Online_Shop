...
<div class="header_bottom">
		<div class="header_bottom_left">
			...
			if(!isset($_GET['brand'])) {
				global $con;
				$get_pro = "select * from products order by RAND() LIMIT 0,2";
				...
				<?php while($row_pro=mysqli_fetch_array($run_pro)) {
					...
					<a href='details.php?pro_id=$pro_id'><img src='admin_area/product_images/$pro_image' alt='' /></a>
					</div>
					<div class='text list_2_of_1'>
					<h2 style='font-size:15px;'>$pro_title</h2>
